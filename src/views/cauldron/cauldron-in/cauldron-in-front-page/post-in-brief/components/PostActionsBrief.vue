<template>
    <div class="post_actions">
        <div class="post_action" @click="emits('gotoDetailPage')">
            <div class="post_action_icon icon_comment">
                <i class="iconfont">&#xe607;</i>
            </div>
            <div class="post_action_info">{{ post.comments }}</div>
        </div>
    ...
    <div v-show="showDislikeReasons" class="dislike_reasons">
        <div class="title">选择你标记反对的原因</div>
        <div class="reason_list">
            <div
                class="dislike_reason"
...
const emits = defineEmits<{
    (event: 'gotoDetailPage'): void,
    (event: 'likePost'): void,
    (event: 'cancelLike'): void,
    (event: 'dislikePost'): void,
    (event: 'cancelDislike'): void
}>()
